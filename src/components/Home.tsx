      ...
      <div className="section-container flex flex-col items-center justify-center min-h-[calc(100vh-80px)]">
        ...
        >
          ...
          >
            ...
            <br />
            <span className="text-dark dark:text-light">V Mohan Balaji</span>
          </motion.h1>
          
          <AnimatedText
            text="A passionate 3rd-year B.Tech student at Sasi Institute, Tadepalligudem, aspiring to be a Full Stack Developer."
            className="text-xl md:text-2xl text-dark/80 dark:text-light/80 mb-8"
            once
          />
        ...
        >
          ...
          <p className="text-center text-sm mt-2 text-dark/60 dark:text-light/60">Scroll Down</p>
        </motion.div>
      </div>
    </SectionTransition>
  );
